...
An example mod to show how to use [SimpleMainMenu-Lib](https://github.com/mosadie/simplemainmenu-lib).
...
2) Replace [the panorama pictures](src/main/resources/assets/smm-lib-example/textures/gui/title/background/normal) with your own. (See [the wiki](https://github.com/MoSadie/SimpleMainMenu-Lib/wiki) for information on creating panorama photos from screenshots)
...
- [SimpleMainMenu-Lib](https://modrinth.com/mod/smm-lib)
